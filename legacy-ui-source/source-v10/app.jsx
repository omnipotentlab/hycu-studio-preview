...
function App() {
  ...
  switch (screen) {
    ...
    case 'editor':
    case 'review':
      body = <Editor deck={deck} setDeck={setDeck} onScreen={onScreen} currentSlide={currentSlide} setCurrentSlide={setCurrentSlide} gridStyle="grid" translateUI="split" defaultLang="en" captionsAlways={false} />; break;
    case 'preview':
      body = <Preview deck={deck} currentSlide={currentSlide} setCurrentSlide={setCurrentSlide} onScreen={onScreen} chroma={false} />; break;
    case 'chroma':
      body = <Chroma deck={deck} currentSlide={currentSlide} setCurrentSlide={setCurrentSlide} onScreen={onScreen} chroma={true} instructorPos={{x:0,y:0}} instructorScale={1} />; break;
    case 'export':
  ...
  return (
    <div className={'app-shell' + (navCollapsed ? ' nav-collapsed' : '')} data-screen-label={screen}>
      ...
      <div className="main">
        ...
        <style>{`
          .app-shell[data-screen-label="export"] .content{padding-bottom:96px!important}
